...
export const fmbApi = {
  ...
  pluginPreInstallCheck(p: MainPluginPreInstallCheckParams) { return getFmb().pluginPreInstallCheck(p) as Promise<MainPluginPreInstallCheckResult>; },
  pluginInstallBatch(p: MainPluginInstallBatchParams) { return getFmb().pluginInstallBatch(p) as Promise<MainPluginInstallBatchResult>; },
  pluginListScheduleTemplates(p: MainPluginListScheduleTemplatesParams = {}) { return getFmb().pluginListScheduleTemplates(p) as Promise<MainPluginListScheduleTemplatesResult>; },
  ...
  dialogShowOpen(p: MainDialogShowOpenParams) { return getFmb().dialogShowOpen(p) as Promise<MainDialogShowOpenResult>; },
